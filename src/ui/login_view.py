...
class LoginView:
    """
    Login näkymästä vastaava luokka

    Attributes:
        root: tkinter olio.
    """
    def __init__(self, root, handle_show_teacher_main_view,handle_show_new_user_view, sevice):
    ...
    def _login(self):
        ...
        if self._sevice.check_user(username,password): 
            ...
            messagebox.showerror("Virhe", "Käyttäjänimi tai salasana ei täsmää\n yritä uudelleen")
